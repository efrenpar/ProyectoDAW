...
function showLoginForm(){
    $('#loginModal').empty();
    $('#loginModal').append('<div class="modal-dialog login animated"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> <h4 >Inicio de sesión</h4> </div> '+
